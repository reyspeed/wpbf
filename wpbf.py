...
if len(sys.argv) <= 1:
    ...
    print ''
    print 'Github: https://github.com/reyspeed'
    print 'Mail   : mrcroot46@gmail.com'
    print ''
    print 'penggunaan: python2 wpbf.py -h http://xnxx.com/wp-login.php -u admin -P password.txt'
    sys.exit()
...
try:
    ...
    #Finish
    print ''       
    print '1 Target succes njeng, '+ str(countAcc) +' valid username+password found'
    print 'TARGER: ' + url
    print 'RESULT:'        
    print result
    sys.exit()
except urllib2.URLError, e:
    print "\n\t[!] Cek sinyal kau Njeng"
